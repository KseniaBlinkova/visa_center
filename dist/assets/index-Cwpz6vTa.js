...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            </div>`;try{const e=await Wr.get(Qs.getVisaById(this.id));this.parent.innerHTML=this.getHTML(e),document.getElementById("save-btn").onclick=()=>this.saveData(),document.getElementById("cancel-btn").onclick=()=>window.renderPage(na)}catch(e){this.parent.innerHTML=`
